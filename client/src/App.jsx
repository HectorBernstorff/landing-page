...
import esgotado from './assets/esgotado.png'
            ...
            <main>
                <div className='background' style={backgroundStyle}>
                    ...
                    <section className='second-section'>
                        ...
                        <div className='second-section-description'>
                            ...
                            <a href="#checkout"><button>QUERO PARTICIPAR</button></a>
                        </div>
                    </section>
                </div>
                ...
                <section className='third-section'>
                    ...
                    <div className='cards-wrapper'>
                        ...
                        <Cards
                            img={planejamento}
                            title="PLANEJAMENTO"
                            content="Vamos analisar a sua situação, em qual etapa do planejamento você está, e a partir disso vamos traçar um planejamento, conversando um pouco sobre vistos, estudos, trabalho e imigração."
                        />
                        <Cards
                            img={materiais}
                            title="MATERIAIS EXCLUSIVOS"
                            content="Acesso imediato a materiais que te dirão o passo a passo a seguir, descobrirá quanto irá gastar no Plano Canadá e tudo que você precisa para o embarque."
                        />
                        <Cards
                            img={duvidas}
                            title="DÚVIDAS"
                ...
                <section className='bonus'>
                    <div className='inner-bonus'>
                        ...
                        <div>
                            <p><span className='bold-bonus underline'>Mais de R$1.740 em descontos</span> com meus grandes parceiros nos serviços de aplicação de vistos, consultoria educacional, imigração, matrícula em college, internet de celular e assessoria na hora de alugar imóvel no Canadá!
                            </p>
                            <p>Além disso, você terá <span className='bold-bonus'>acesso imediato a materiais exclusivos</span>, as ferramentas corretas para alcançar seus objetivos! Como o calendário de planejamento personalizado, todo planejamento financeiro e TUDO o que você precisa saber antes de embarcar desde documentos, remédios a preparação da mala. Todos esses materiais estão avaliados em<span className='bold-bonus'> mais de R$200 e serão fornecidos como bônus da mentoria.</span>
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className='valor-section' id='checkout'>
                    <div className='valor-description'>
                        ...
                        <button>Quero morar no Canada!</button>
                        <div className='seguranca'>
                            ...
                            <img className='esgotadas' src={esgotado} alt="" />
                        </div>
                    </div>
                </section>
            </main>
